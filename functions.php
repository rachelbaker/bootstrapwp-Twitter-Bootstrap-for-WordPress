 ...
 * Include files.
 */
require get_template_directory() . '/includes/class-bootstrapwp_walker_nav_menu.php';
...
function bootstrapwp_scripts_loader() {
	...
	if ( is_single() && comments_open() || is_singular() && comments_open() ) {
...
if ( ! function_exists( 'bootstrapwp_content_nav' ) ) :
	function bootstrapwp_content_nav( $nav_id = 'nav-below' ) {
		...
		if ( $wp_query->max_num_pages > 1 ) : ?>
			...
			<nav id="<?php echo $nav_id; ?>" class="navigation" role="navigation">
				<h3 class="assistive-text"><?php _e( 'Posts navigation', 'bootstrapwp' ); ?></h3>
				<ul class="pager">
					<li class="previous">
						<?php previous_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'bootstrapwp' ) ); ?>
					</li>
					<li class="next">
						<?php next_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'bootstrapwp' ) ); ?>
					</li>
				</ul>
			</nav>
		...
		<?php elseif ( is_single() ) : ?>
			...
			<nav id="<?php echo $nav_id; ?>" class="navigation" role="navigation">
				<h3 class="assistive-text">
					<?php _e( 'Single Post navigation', 'bootstrapwp' ); ?>
				</h3>
				<ul class="pager">
					<li class="previous">
						<?php previous_post_link( '%link', _x( '<span class="meta-nav">&larr;</span> %title', 'Previous post', 'bootstrapwp' ) ); ?>
					</li>
					<li class="next">
						<?php next_post_link( '%link', _x( '%title <span class="meta-nav">&rarr;</span>', 'Next post', 'bootstrapwp' ) ); ?>
					</li>
				</ul>
			</nav>
	...
	function bootstrapwp_post_nav() {
		...
		<nav class="navigation post-navigation" role="navigation">
			...
			<ul class="pager">
				...
				<?php previous_post_link( '%link', _x( '<li class="previous">&larr;</li> %title', 'Previous post link', 'bootstrapwp' ) ); ?>
				<?php next_post_link( '%link', _x( '<li class="next">&rarr;</li> %title', 'Next post link', 'bootstrapwp' ) ); ?>
