...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<header class="jumbotron subhead">
		<div class="container">
			...
			<p class="lead">
				Bring Bootstrap's components to life&mdash;now with 13 custom jQuery plugins.
		</div>
	</header>
...
================================================== -->
	...
	<div class="col-md-3 bs-docs-sidebar">
		<ul class="nav nav-list bs-docs-sidenav">
			<li>
				<a href="#overview"> <i class="glyphicon-chevron-right"></i>
					Overview
				</a>
			</li>
			<li>
				<a href="#transitions"> <i class="glyphicon-chevron-right"></i>
					Transitions
				</a>
			</li>
			<li>
...
================================================== -->
	<section id="overview">
		...
		<p>
			Plugins can be included individually (though some have required dependencies), or all at once. Both
			<strong>bootstrap.js</strong>
			and <strong>bootstrap.min.js</strong>
...
$("#myModal").modal('show')                // initializes and invokes show immediately</p>
		...
		<p>
			Sometimes it's neccessary to use bootstrap plugins with other ui frameworks. In these circumstances, occasionally namespace collisions can occur. If this happens, you may call
			<code>.noCoflict</code>
...
================================================== -->
	<section id="transitions">
		<div class="page-header">
			<h1>
				Transitions
				<small>bootstrap-transition.js</small>
			</h1>
		</div>
		<h3>About transitions</h3>

		<p>
			For simple transition effects, include bootstrap-transition.js once alongside the other JS files. If you're using the compiled (or minified) bootstrap.js, there is no need to include this&mdash;it's already there.
		</p>
...
================================================== -->
	...
	<div class="page-header">
		<h1>
			Modals
			<small>bootstrap-modal.js</small>
		</h1>
	</div>
...
&lt;/div&gt;
	...
	<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-body">
			...
			<p>
				This
				<a href="#" role="button" class="btn popover-test" title="A Title" data-content="And here's some amazing content. It's very engaging. right?">button</a>
	...
	<table class="table table-bordered table-striped">
		...
		<tr>
			...
			<td>
				...
				<pre class="prettyprint linenums"><code>&lt;a data-toggle="modal" href="remote.html" data-target="#modal"&gt;click me&lt;/a&gt;</code></pre>
			</td>
		</tr>
		</tbody>
	</table>
...
================================================== -->
	...
	<div class="page-header">
		<h1>
			Dropdowns
			<small>bootstrap-dropdown.js</small>
		</h1>
	</div>
					...
					<ul class="nav" role="navigation">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
								<li>
									<a tabindex="-1" href="http://google.com">Action</a>
								</li>
								<li>
									<a tabindex="-1" href="#anotherAction">Another action</a>
								</li>
								<li>
...
================================================== -->
	<section id="scrollspy">
		<div class="page-header">
			<h1>
				ScrollSpy
				<small>bootstrap-scrollspy.js</small>
			</h1>
		</div>
...
================================================== -->
	<section id="tooltips">
		<div class="page-header">
			<h1>
				Tooltips
				<small>bootstrap-tooltip.js</small>
			</h1>
		</div>
		...
		<div class="bs-docs-example tooltip-demo">
			<p class="muted" style="margin-bottom: 0;">
				...
				<a href="#" rel="tooltip" title="Another tooltip">have a</a>
				...
				<a href="#" rel="tooltip" title="Another one here too">whatever keytar</a>
				, scenester farm-to-table banksy Austin
				<a href="#" rel="tooltip" title="The last tip!">twitter handle</a>
...
================================================== -->
	...
	<div class="page-header">
		<h1>
			Popovers
			<small>bootstrap-popover.js</small>
		</h1>
	</div>
	...
	<p>
		No markup shown as popovers are generated from JavaScript and content within a
		<code>data</code>
		attribute.
	</p>
	...
	<div class="bs-docs-example tooltip-demo">
		<ul class="bs-docs-tooltip-examples">
			...
			<li>
				<a href="#" class="btn" rel="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="Popover on bottom">Popover on bottom</a>
			</li>
			<li>
				<a href="#" class="btn" rel="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="Popover on left">Popover on left</a>
			</li>
		</ul>
	</div>
...
================================================== -->
	<section id="alerts">
		<div class="page-header">
			<h1>
				Alert messages
				<small>bootstrap-alert.js</small>
			</h1>
		</div>
...
================================================== -->
	<section id="buttons">
		<div class="page-header">
			<h1>
				Buttons
				<small>bootstrap-button.js</small>
			</h1>
		</div>
		...
		<p>
			Add
			<code>data-loading-text="Loading..."</code>
		...
		<p>
			Add
			<code>data-toggle="buttons-checkbox"</code>
...
&lt;/div&gt;
		...
		<p>
			Add
			<code>data-toggle="buttons-radio"</code>
...
&lt;/div&gt;
		...
		<div class="alert alert-info">
			<strong>Heads up!</strong>
			<a href="https://github.com/twitter/bootstrap/issues/793">Firefox persists the disabled state across page loads</a>
...
================================================== -->
	...
	<div class="page-header">
		<h1>
			Collapse
			<small>bootstrap-collapse.js</small>
		</h1>
	</div>
...
================================================== -->
	<section id="carousel">
		<div class="page-header">
			<h1>
				Carousel
				<small>bootstrap-carousel.js</small>
			</h1>
		</div>
			...
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					<div class="item active">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/bootstrap-mdo-sfmoma-01.jpg" alt="">
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/bootstrap-mdo-sfmoma-02.jpg" alt="">
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/bootstrap-mdo-sfmoma-03.jpg" alt="">
				...
				<a class="left carousel-control" href="#myCarousel" data-slide="prev">
					<spanclass="control">&lsaquo;</span>
				</a>
				<a class="right carousel-control" href="#myCarousel" data-slide="next">
					<spanclass="control">&rsaquo;</span>
				</a>
			</div>
		</div>
                            <pre class="prettyprint linenums">
...
================================================== -->
	<section id="typeahead">
		<div class="page-header">
			<h1>
				Typeahead
				<small>bootstrap-typeahead.js</small>
			</h1>
		</div>
		...
		<table class="table table-bordered table-striped">
			...
			<tr>
				...
				<td>
					...
					<code>query</code>
					value in the input field and the
					<code>process</code>
					callback. The function may be used synchronously by returning the data source directly or asynchronously via the
					<code>process</code>
			...
			<tr>
				...
				<td>
					The method used to determine if a query matches an item. Accepts a single argument, the
					<code>item</code>
			...
			<tr>
				...
				<td>
					Method used to sort autocomplete results. Accepts a single argument
					<code>items</code>
					and has the scope of the typeahead instance. Reference the current query with
					<code>this.query</code>
					.
				</td>
			</tr>
			<tr>
				...
				<td>
					The method used to return selected item. Accepts a single argument, the
					<code>item</code>
			...
			<tr>
				...
				<td>
					Method used to highlight autocomplete results. Accepts a single argument
					<code>item</code>
...
================================================== -->
	<section id="affix">
		<div class="page-header">
			<h1>
				Affix
				<small>bootstrap-affix.js</small>
			</h1>
		</div>
		...
		<div class="alert alert-info">
			<strong>Heads up!</strong>
			You must manage the position of a pinned element and the behavior of its immediate parent. Position is controlled by
			<code>affix</code>
			,
			<code>affix-top</code>
			, and
